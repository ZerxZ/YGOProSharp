...
namespace WindBot.Game.AI.Decks
{
    ...
    public class YubelExecutor : DefaultExecutor
    {
        ...
        public YubelExecutor(GameAI ai, Duel duel) : base(ai, duel)
        {
            ...
            // === SPIRIT GATES ===
            AddExecutor(ExecutorType.Activate, CardId.SPIRIT_GATES, S4_ActivateSpiritGates);
            AddExecutor(ExecutorType.Activate, CardId.SPIRIT_GATES, Gate_RecycleContinuous);
            ...
            AddExecutor(ExecutorType.Activate, CardId.SPIRIT_GATES, Gate_Revive00Fiend);       // e2: 喔椸复喙夃竾喔∴阜喔?喔娻父喔?Fiend 0/0
        ...
        // === Spirit Gates state ===
        int _gateReviveTargetId = 0;
        int _gateDiscardPreferredId = 0;
        bool _gateWantsRecycle = false;   // 喔佮赋喔ム副喔囙笀喔班竵喔斷箓喔浮喔斷箑喔佮箛喔?Continuous
        ...
        // 喙€喔覆 mask 喔傕腑喔囙笂喙堗腑喔囙浮喔笝喔箑喔曕腑喔｀箤喔椸傅喙堗弗喔脆竾喔佮箤喙€喔｀覆喔娻傅喙?(喙€喔夃笧喔侧赴 Main Monster Zone 0..4)
        private int GetMyLinkedMMZMask()
        {
            ...
            // 喙€喔覆喙€喔夃笧喔侧赴 5 喙傕笅喔權斧喔ム副喔?(喔氞复喔?0..4)
            mask &= 0x1F;
            return mask;
        }
        ...
        {
            // 喙冟笂喙夃笀喔侧竵 "喔∴阜喔? 喙€喔炧阜喙堗腑喔勦箟喔?DBB/CSB
            if (Type != ExecutorType.Activate) return false;
            if (Card.Location != CardLocation.Hand) return false;
            if (Bot.HasInSpellZone(CardId.SPIRIT_GATES, true, true)) return false;

            // 喔佮笌: 喔栢箟喔侧浮喔?DBB 喔涪喔灌箞 "喔氞笝喔笝喔侧浮" 喙冟斧喙夃竸喙夃笝 CSB
            int pick = 0;
        ...
        {
            // e3: 喔∴傅喙€喔ム箑喔о弗 10 -> 喙€喔佮箛喔?Continuous Spell 喔堗覆喔佮釜喔膏釜喔侧笝 (喙€喔權箟喔權箑喔佮箛喔?NIGHTMARE_PAIN)
            ...
            // 喙€喔ム阜喔竵 Pain 喔佮箞喔笝 喔栢箟喔侧箘喔∴箞喔∴傅喔勦箞喔涪喙€喔ム阜喔竵 Paradise 喔曕腑喔?select card
            return true;
        }
        private bool Is00FiendId(int id)
        {
            // 喔｀覆喔⑧笂喔粪箞喔?0/0 Fiend 喔椸傅喙堗箑喔｀覆喙冟笂喙夃箖喔權箑喔斷箛喔勦笝喔掂箟
        ...
        // 喙€喔ム阜喔竵喙€喔涏箟喔侧斧喔∴覆喔⑧笚喔掂箞喔堗赴喔娻父喔?喔斷箟喔о涪喔ム赋喔斷副喔氞竸喔о覆喔∴釜喔赤竸喔编笉喔曕覆喔?2.2.x
        private int PlanSpiritGatesReviveTarget()
        {
            ...
            // 2.2.2: 喔栢箟喔侧競喔侧笖 spirit 鈫?SS spirit (喔堗覆喔佮釜喔膏釜喔侧笝 喔福喔粪腑喔椸复喙夃竾喔堗覆喔佮浮喔粪腑)
            ...
            // 2.2.3: 喔栢箟喔?DBB 喙傕笖喔權競喔编笖/喔曕副喔權箑喔佮浮喙佮弗喙夃抚喔∴傅 Almiraj 鈫?喔娻父喔?DBB 喙€喔炧阜喙堗腑喙勦笗喙堗箘喔?Moon
            if (Bot.HasInMonstersZone(CardId.SALAMANGREAT_ALMIRAJ, true)
                && Bot.HasInGraveyard(CardId.DARK_BECKONING_BEAST)
                && HasInExtra(CardId.MOON_OF_THE_CLOSED_HEAVEN))
                return CardId.DARK_BECKONING_BEAST;

            // 2.2.1: 喔栢箟喔侧競喔侧笖 lotus 鈫?SS lotus
            ...
            // 喔椸覆喔囙箑喔ム阜喔竵喔椸副喙堗抚喙勦笡: DBB > CSB > Yubel
            ...
            // 喔栢箟喔侧箘喔∴箞喔∴傅喔赴喙勦福喔娻父喔氞箘喔斷箟喙€喔ム涪 喔覆喔堗抚喔侧竾喙佮笢喔?discard 喙冟斧喙?Spirit 喔ム竾喔父喔覆喔權箒喔ム箟喔о竸喙堗腑喔⑧笂喔膏笟
            if (!spiritOnBoard && spiritInHand) return CardId.SPIRIT_OF_YUBEL;

            return 0;
        }

        // 喙€喔ム阜喔竵喙冟笟喔堗赴喔椸复喙夃竾: CSB > Paradise > Terror > (喔氞覆喔囙竵喔｀笓喔? Spirit
        private int PickSpiritGatesDiscard(int reviveTargetId)
        {
            // 喙€喔勦釜喔涪喔侧竵喔娻父喔?Spirit 喙佮笗喙堗涪喔编竾喔涪喔灌箞喙冟笝喔∴阜喔?鈫?喔椸复喙夃竾 Spirit 喙€喔涏箛喔?cost 喙佮弗喙夃抚喔娻父喔氞浮喔编笝喙€喔竾
            ...
            // fallback: 喙€喔ム阜喔竵喙冟笟喔椸傅喙?"喔椸复喙夃竾喙佮弗喙夃抚喙€喔堗箛喔氞笝喙夃腑喔⑧釜喔膏笖"
        ...
        {
            // e2: 喔椸复喙夃竾喔∴阜喔?1 鈫?SS Fiend 0/0 喔堗覆喔佮釜喔膏釜喔侧笝
            if (Card.Location != CardLocation.SpellZone) return false;
            
            if (requiemSummoned)
            {
                if (!Bot.HasInHandOrInGraveyard(CardId.SPIRIT_OF_YUBEL)) return false; // 喔曕箟喔竾喔∴傅喙冟笝喔弗喔膏浮
                if (Bot.Hand.Count <= 0) return false;                          // 喔曕箟喔竾喔∴傅喙冟笟喔椸复喙夃竾
            ...
            // 喔о覆喔囙箒喔溹笝喔佮箞喔笝喔о箞喔侧笀喔班笂喔膏笟喔曕副喔о箘喔笝
            int target = PlanSpiritGatesReviveTarget();
            if (target == 0) return false;

            // 喔曕箟喔竾喔∴傅喔佮覆喔｀箤喔斷箖喔箟喔椸复喙夃竾喔涪喙堗覆喔囙笝喙夃腑喔?1 喙冟笟
            ...
            // 喙勦浮喙堗箑喔ム阜喔竵喔赴喙勦福喔曕福喔囙笝喔掂箟 喔涏弗喙堗腑喔⑧箖喔箟 OnSelectCard 喔堗复喙夃浮 cost/喙€喔涏箟喔侧斧喔∴覆喔⑧箖喔箟
            return true;
        }
        ...
        private bool ActTract()
        {
            ...
            // 喔栢箟喔侧箑喔傕箟喔?Fiendsmith line 喙佮弗喙夃抚 -> 喙勦浮喙堗箖喔娻箟 Tract
        ...
        {
            if (Card.Location != CardLocation.MonsterZone) return false;
            // Quick Link 喙€喔夃笧喔侧赴喙€喔椸复喔｀箤喔權辅喔编笗喔｀腹喔娻箞喔о竾 Main 喙€喔炧阜喙堗腑喔福喙夃覆喔?1 interrupt
            if (Duel.Player != 1) return false;
            ...
            // 喔箞喔о笝喙冟斧喔嵿箞喙€喔笝喔堗复喔權笀喔班笘喔侧浮喙€喔ム阜喔竵喔佮覆喔｀箤喔斷笣喔编箞喔囙笗喔｀竾喔傕箟喔侧浮喔椸傅喙堗笀喔班箖喔娻箟喙€喔涏箛喔權抚喔编釜喔斷父/喔福喔粪腑喙勦弗喙?            AI.SelectCard(target);
            return DontSelfNG();
        }
        private bool SSPhantom()
        {
            ...
            // 喔о副喔曕笘喔膏笖喔脆笟喙冟笟喔椸傅喙?2 喔堗覆喔佮釜喔膏釜喔侧笝喔曕覆喔∴笚喔掂箞喔堗副喔斷箘喔о箟
        ...
        private bool ActVarudras()
        {
            ...
            // 喔｀覆喔⑧竵喔侧福喙€喔涏箟喔?(喔ㄠ副喔曕福喔灌竵喙堗腑喔?喔栢箟喔侧箘喔∴箞喔∴傅喔勦箞喔涪 fallback)
            List<ClientCard> targetList = GetNormalEnemyTargetList(true, true);
            int desc = ActivateDescription;
            int d1 = Util.GetStringId(CardId.VARUDASN_FINAL_BRINGER, 1); // 喙冟笂喙夃笚喔编箟喔?e1 (Negate) 喙佮弗喔?e2 (Battle Start destroy)
            ...
            // e1: Quick effect Negate (喔澿副喙堗竾喔勦腹喙堗笗喙堗腑喔腹喙夃竵喔斷箑喔笩喙€喔熰竵喔曕箤)
            if (desc == d1 && Duel.LastChainPlayer == 1 && Duel.CurrentChain.Count > 0)
            {
                if (!CheckLastChainShouldNegated()) return false;
                activatedCardIdList.Add(Card.Id); // 喙佮笚喙囙竵喔о箞喔侧箑喔涏箛喔?e1
                return true; // 喙€喔笝喔堗复喔權笀喔班笀喔编笖喔佮覆喔?detach 喙€喔涏箛喔?cost 喙冟斧喙夃箑喔竾
            }

            // e2: Battle Start 喔椸赋喔ム覆喔?1 / e3: 喔栢腹喔佮笚喔赤弗喔侧涪喙佮弗喙夃抚喔椸赋喔ム覆喔?1
        ...
        private bool L4ABOSS()
        {
            ...
            // 3) greedy: 喙€喔ム阜喔竵喔ム复喔囙竵喙屶笚喔掂箞喔∴傅喔涪喔灌箞喔佮箞喔笝 (prefer Rage > Yama > 喔阜喙堗笝 喙? 喙佮弗喙夃抚喙€喔曕复喔∴竵喔侧福喙屶笖喔堗笝喙佮笗喙夃浮喔｀抚喔∴竸喔｀笟 4
            ...
            if (firstLink != null)
            {
                // 避开 NEVER_SAC 里的保护材料，再补齐 Link 值。
                var pool = mons
                    .Where(m => m != firstLink && !NEVER_SAC.Contains(m.Id))
                    .OrderBy(ScoreOwnCardForCost) // 喙€喔傅喔⑧笝喙夃腑喔⑧釜喔膏笖喔∴覆喔佮箞喔笝
                    .ToList();
        ...
        private ClientCard[] GetSafeMaterialsExcluding(HashSet<int> excludeIds, int need)
        {
            return Bot.GetMonsters()
                .Where(m => m != null
                            ...
                            && !IsProtectedMaterial(m)      // 喙勦浮喙堗涪喔浮喙佮弗喔佮競喔竾喔赋喔勦副喔?(Link鈮? / Extra 喔弗喔?
                       )
                .OrderBy(m => PriorityIndex(m.Id))
                .ThenBy(m => m.Attack)
                .Take(need)
        ...
        {
            // 喔曕箟喔竾喔∴傅 Yama 喔涪喔灌箞喔佮箞喔笝 喙佮弗喔班笗喙夃腑喔囙浮喔掂抚喔编笗喔栢父喔斷复喔氞腑喔粪箞喔?2 喙冟笟 (喙勦浮喙堗笝喔编笟 Yama)
            if (!Bot.HasInMonstersZone(CardId.UNCHAINED_LORD_OF_YAMA, true)) return false;
            if (!CanMakeRageWithoutYama()) return false;

            var mats = GetSafeMaterialsExcluding(new HashSet<int> { CardId.UNCHAINED_LORD_OF_YAMA }, 2);
            if (mats.Length < 2) return false;  // 喔⑧副喔囙箘喔∴箞喔炧腑 鈫?喔｀腑喔佮箞喔笝 喔涪喙堗覆喔澿阜喔權箖喔娻箟 Yama
        ...
        {
            // 喔涏竵喔曕复 MonsterZone 喔∴傅 7 喔娻箞喔竾 (0..4 = MMZ, 5..6 = EMZ)
            var mz = Bot.MonsterZone;
        ...
        private bool YesNoFor(int desc, int cardId, int idx)
        {
            ...
            // 通过提示描述和当前 chain 牌共同确认 yes/no 来源。
        ...
        public override bool OnSelectYesNo(int desc)
        {
            ...
            { return false; }
            // --- Nightmare Throne ---
            // 通过 desc 和 solving 共同锚定 Nightmare Throne 的提示来源。
            if (solving != null && solving.IsCode(CardId.NIGHTMARE_THRONE))
            {
                // 输出 desc map，方便确认 index 对应关系。
                DebugThroneDescMap(desc);

                // 喔⑧副喔囙箘喔∴箞喙勦笖喙夃箑喔｀复喙堗浮喔勦箟喔?-> 喔曕腑喔?YES 喙€喔炧阜喙堗腑喙€喔傕箟喔侧箓喔浮喔斷竸喙夃笝
                ...
                // 喔勦箟喔權箑喔福喙囙笀喙佮弗喙夃抚 喙佮弗喔班竵喔赤弗喔编竾喔栢覆喔?"喔堗赴喔椸赋喔ム覆喔⑧箘喔浮?" -> default = NO
                if (_throneStage == ThroneStage.AwaitDestroyPrompt || throneSearched)
                {
                    _throneStage = ThroneStage.None;
                    return false; // 喙勦浮喙堗笚喔赤弗喔侧涪
                }

                // 喔佮副喔權箑喔勦釜 engine 喔栢覆喔∴笅喙夃赋喔佮箞喔笝喙傕笂喔о箤喙€喔斷箛喔? 喔曕腑喔?YES 喙勦笡 (喔堗赴喙勦笡喙€喔傕箟喔?OnSelectCard)
            ...
            {
                if (Duel.ChainTargets.Contains(Card)) return false; // 喔曕副喔о箑喔竾喔佮赋喔ム副喔囙箓喔斷笝喙€喔ム箛喔囙笚喔赤弗喔侧涪 -> 喙勦浮喙堗箖喔娻箟
            ...
            // --- Varudras: 喔栢覆喔∴笘喔笖喔о副喔曕笘喔膏笖喔脆笟喔傅喔?1 喙€喔炧阜喙堗腑喔椸赋喔ム覆喔?---
            ...
            if (solving != null
                ...
                && Duel.CurrentChain.Count > 0) // 喙佮笡喔ム抚喙堗覆喔涪喔灌箞喙冟笝 e1 喙勦浮喙堗箖喔娻箞 e2
            {
                // 喔∴傅喙€喔涏箟喔侧辅喔编笗喔｀腹喙冟斧喙夃笚喔赤弗喔侧涪喙勦斧喔?
                var t = GetNormalEnemyTargetList(true, true).FirstOrDefault(c => c.Controller == 1);
                if (t == null) return false;                // 喙勦浮喙堗浮喔掂箑喔涏箟喔?鈫?喙勦浮喙堗笘喔笖
                return ShouldVarudrasDetachForPop(t);
            }

            // aux.Stringid(78371393,2) -> 喔勦赋喔栢覆喔?"喔堗赴喔副喔囙箑喔о涪喙勦斧喔?"
            if (YesNoFor(desc, CardId.YUBEL, 2))
            {
                // 检查 Lotus 是否已经在场上，决定是否接受 Yubel 的解放提示。
                bool haveLotusOnField = Bot.GetMonsters().Any(m => m != null && m.Id == CardId.SAMSARA_D_LOTUS);

                // 喔栢箟喔侧浮喔?喔堗赴喔曕腑喔?YES 喙佮弗喔班笗喔编箟喔囙笜喔囙抚喙堗覆喔佮赋喔ム副喔囙笀喔班箑喔ム阜喔竵喔曕副喔о釜喔编竾喙€喔о涪喙冟斧喙?Yubel
                _yubelWantsTribute = haveLotusOnField;
                return haveLotusOnField; // YES 喔栢箟喔侧浮喔?Lotus, NO 喔栢箟喔侧箘喔∴箞喔∴傅 => Yubel 喔｀赴喙€喔氞复喔斷笗喔编抚喙€喔竾
            }
        ...
        public override IList<ClientCard> OnSelectCard(IList<ClientCard> cards, int min, int max, int hint, bool cancelable)
        {
            ...
            hint.ToString().ToLower().Contains("release");
            var solving = Duel.GetCurrentSolvingChainCard();
            if (cards != null && cards.Count > 0)
            {
                ...
                if (_throneStage == ThroneStage.Searching && solving != null && solving.IsCode(CardId.NIGHTMARE_THRONE) && !throneSearched && cards != null && cards.Count > 0)
                {
                    ...
                    // fallback：优先选 Yubel 系列候选，否则使用第一个候选。
                    if (chosen == null)
                ...
                if (Card != null && Card.Id == CardId.SPIRIT_GATES && cards != null && cards.Count > 0)
                {
                    ...
                    // 喙€喔ム阜喔竵喙€喔涏箟喔侧斧喔∴覆喔⑧笂喔膏笟喔堗覆喔佮釜喔膏釜喔侧笝 (Fiend 0/0)
                ...
                // === Throne: 喙€喔ム阜喔竵喔佮覆喔｀箤喔斷笚喔掂箞喔勦箟喔權箑喔堗腑 ===
                ...
                if (_yubelWantsTribute && isReleasePrompt && cards != null && cards.Count > 0)
                {
                    ...
                    if (lotus != null)
                    {
                        _yubelWantsTribute = false; // 喙€喔勦弗喔掂涪喔｀箤喔樴竾
                        return new[] { lotus };
                    }
                    // 喙€喔溹阜喙堗腑喔佮福喔撪傅喙€喔笝喔堗复喔權釜喙堗竾喔ム复喔笗喙屶浮喔侧箒喔曕箞喔斷副喔權箘喔∴箞喔∴傅 Lotus (喙勦浮喙堗竸喔о福喙€喔佮复喔?喙€喔炧福喔侧赴喙€喔｀覆喔曕腑喔?YES 喙€喔∴阜喙堗腑喔∴傅 Lotus)
                    _yubelWantsTribute = false;
                    // 继续交给后续 fallback 选择逻辑。
                }
                // --- Varudras: 喙€喔ム阜喔竵喙€喔涏箟喔侧斧喔∴覆喔⑧笚喔赤弗喔侧涪 ---
                if (Card.Id == CardId.VARUDASN_FINAL_BRINGER && hint == 502 && cards != null && cards.Count > 0)
                {
                    // 喔炧涪喔侧涪喔侧浮喙€喔ム阜喔竵喔澿副喙堗竾喔ㄠ副喔曕福喔灌竵喙堗腑喔?(喔勦副喔斷箖喔氞笚喔掂箞喔副喔權笗喔｀覆喔?喔涏箞喔о笝喔椸傅喙堗釜喔膏笖)
                    var enemyPick = cards
                ...
                // --- Abomination: 喙€喔ム阜喔竵喙€喔涏箟喔侧斧喔∴覆喔⑧笚喔赤弗喔侧涪 ---
                ...
                if (solving != null && solving.IsCode(CardId.UNCHAINED_SOUL_OF_RAGE) && cards.Any(c => c != null && c.Location == CardLocation.Extra))
                {
                    ...
                    if (pickGorgon != null)
                    {
                        ...
                        // EMZ 不可用时不要优先选 Gorgon，继续走 fallback。
                    }

                    // 3) fallback：使用第一个候选材料。
